...
const styles = StyleSheet.create({
  ...
  counterText: { color: "#94a3b8", fontSize: 14, flexShrink: 1 },
  cardContainer: { marginBottom: 20, position: "relative" },
  card: {
    position: "absolute",
    width: "100%",
    height: "100%",
  ...
  audioWrapper: { position: "absolute", alignSelf: "center", zIndex: 999 },
